      ...
      ? [
          {
            ...
            hoverBg:
              'hover:bg-danger/10 hover:border-danger/60 hover:shadow-sm hover:shadow-danger/10',
      ...
      ? [
          {
            ...
            hoverBg:
              'hover:bg-warning/8 hover:border-warning/55 hover:shadow-sm hover:shadow-warning/10',
      ...
      ? [
          {
            ...
            hoverBg:
              'hover:bg-accent/8 hover:border-accent/45 hover:shadow-sm hover:shadow-accent/10',
    ...
    return (
      <div className="mb-3 last:mb-0">
        <div className="flex items-center gap-1.5 mb-1.5 px-0.5">
          ...
          <span className={`text-xs font-semibold tracking-widest uppercase ${cfg.textColor}`}>
            {cfg.label}
          </span>
        </div>
        <div className="space-y-1.5">
          {actions.map((action) => (
            ...
            >
              <div
                className={`w-8 h-8 rounded-lg ${action.iconBg} flex items-center justify-center flex-shrink-0 mt-0.5`}
              >
              ...
              <ArrowRight
                size={14}
                className={`${action.iconColor} opacity-60 group-hover:opacity-100 group-hover:translate-x-0.5 mt-1 flex-shrink-0 transition-all duration-150`}
              />
            </Link>
          ))}
        </div>
