    ...
    <AppLayout>
      <div className="flex flex-col h-full min-h-screen bg-background">
        ...
        <div className="border-b border-border/50 px-6 py-5">
          ...
          <p className="text-sm text-text-muted mt-1">Portfolio alerts and notifications</p>
        </div>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-20">
          <div className="text-center max-w-md">
            ...
            <div className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-elevated border border-border text-xs text-text-muted">
