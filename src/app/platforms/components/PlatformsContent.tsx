        ...
        <div className="rounded-xl border border-border/40 bg-surface overflow-hidden">
          ...
          {loading && !data ? (
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-border/40 bg-surface-elevated/50">
                  <th className="text-left px-5 py-3 text-xs font-semibold uppercase tracking-wider text-accent/80">Platform</th>
                  <th className="text-right px-5 py-3 text-xs font-semibold uppercase tracking-wider text-accent/80">Leads</th>
                  <th className="text-right px-5 py-3 text-xs font-semibold uppercase tracking-wider text-accent/80">Converted</th>
                  <th className="px-5 py-3 text-xs font-semibold uppercase tracking-wider text-accent/80 w-52">Conversion Rate</th>
                </tr>
              </thead>
              <tbody>
